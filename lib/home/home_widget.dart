    ...
    return StreamBuilder<List<AlertsRecord>>(
      stream: queryAlertsRecord(
        queryBuilder: (alertsRecord) =>
            alertsRecord.orderBy('date', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<AlertsRecord> homeAlertsRecordList = snapshot.data!;
                ...
                children: [
                  ...
                  StreamBuilder<List<EventsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<EventsRecord> nexteventEventsRecordList =
                          snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final nexteventEventsRecord =
                          nexteventEventsRecordList.isNotEmpty
                              ? nexteventEventsRecordList.first
                              : null;
                      return Column(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${dateTimeFormat('M/d h:mm a', nexteventEventsRecord!.startDate)} - ${dateTimeFormat('M/d h:mm a', nexteventEventsRecord!.endDate)}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              await launchURL(
                                  getRemoteConfigString('survey_url'));
                            },
                            child: Container(
                              width: double.infinity,
                              decoration: BoxDecoration(
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(18.0, 8.0, 18.0, 25.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
